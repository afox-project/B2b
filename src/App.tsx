...
// Import Figma images
import imgFrame15 from "figma:asset/70a9e0d8bf18903bba982d7571a709cddd053c2b.png";
...
import imgRectangle1495 from "figma:asset/5c2ecd3323fd4e813da96bcd0f8700555f0fcac5.png";
  ...
  const benefits = [
    {
      ...
      description: 'От 1 дня до выхода на объект. Экстренная замена за 24 часа.',
      stat: 'От 1 дня'
    },
    {
      icon: Shield,
        ...
        <div className="max-w-[1400px] mx-auto px-6 lg:px-12">
          <div className="flex items-center justify-between h-20">
            ...
            <nav className="hidden lg:flex items-center gap-10">
              <a href="#services" className="text-sm text-slate-900 font-medium cursor-pointer hover:text-yellow-500 transition-colors">Услуги</a>
      ...
      <section id="positions" className="py-20 lg:py-28">
        <div className="max-w-[1400px] mx-auto px-6 lg:px-12">
          <div className="flex items-end justify-between mb-12">
            ...
            <button onClick={() => setCurrentPage('job')} className="hidden lg:block text-slate-900 font-semibold hover:text-yellow-500 transition-colors cursor-pointer flex items-center gap-2 bg-transparent border-none">
              Все должности
              <ArrowRight className="w-5 h-5" />
            </button>
          </div>
            ...
            {caseStudies.map((caseItem, idx) => (
              <div key={idx} className="group bg-white rounded-2xl overflow-hidden hover:shadow-2xl transition-all border-2 border-slate-100 cursor-pointer">
                ...
                <div className="p-8">
                  ...
                  <button className="text-slate-900 font-semibold hover:text-yellow-500 transition-colors flex items-center gap-2 cursor-pointer">
                    Читать кейс
        ...
        <div className="max-w-[1400px] mx-auto px-6 lg:px-12">
          ...
          <div className="border-t border-slate-800 pt-8 flex flex-col md:flex-row items-center justify-between gap-6">
            ...
            <div className="flex gap-8 text-slate-500">
              <a href="#" className="hover:text-white transition-colors cursor-pointer">П��литика конфиденциальности</a>
